...
/* Página para ver la Lista de Documentos Firmados del Cliente Autenticado. Puedes entrar a esta página desde esta URL:
...
const Index = () => {
  ...
  * */
  ...
  /* API para coger los Documentos Firmados del Cliente Autenticado.
  *
  ...
  useEffect(() => {
      const fetchData = async () => {
        try {
          ...
          axios.post(`${process.env.NEXT_PUBLIC_API_ROOT}/api/member-signed-documents/`, { userId: userId })
            .then(response => {
                  ...
                  <TableRow key={document.document_type__id}>
                    ...
                    <TableCell style={{ color: 'white' }}>{document.document_type__name}</TableCell>
                      ...
                      <TableCell style={{ color: 'white' }}>
                        <NextLink href={`/documents/signed-documents/${document.document_type__id}`} passHref>
                          <Button component="a" variant="contained" color="primary">
                            Ver Documento
                          </Button>
                        </NextLink>
