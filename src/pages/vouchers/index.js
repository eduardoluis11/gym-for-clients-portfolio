...
/* Página con la Lista de Bonos.
*
* EDITÉ esta página para que el Cliente NO pueda crear nuevos bonos, ni importar ni exportar servicios, ni tampoco pueda
* eliminarlos.
*
* Adicionalmente, EDITÉ esta página para que el Cliente NO pueda buscar ni filtrar bonos en la barra de búsqueda, ya que
* la barra de búsqueda no funciona, y da un error si intentas hacer una búsqueda.
* */
        ...
        <Container maxWidth="xl">
          <Box sx={{ mb: 4 }}>
            ...
            >
              ...
              {/* Botón de "Añadir" para crear un nuevo Bono. BORRAR. */}
              {/*<Grid item>*/}
          ...
          <Card>
            ...
            {/* Barra de Búsqueda y Filtros. BORRAR. */}
            {/*<Box*/}
            {/*  sx={{*/}
            {/*    alignItems: 'center',*/}
            {/*    display: 'flex',*/}
